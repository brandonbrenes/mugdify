...
function custom_hero_register_styles() {
    ...
    wp_register_style('custom-hero-shop-style', plugin_dir_url(__FILE__) . 'hero-widget-shop.css');
}
...
function custom_hero_shop_shortcode() {
    // Encolar el estilo solo cuando se use el shortcode
    wp_enqueue_style('custom-hero-shop-style');
...
add_shortcode('custom-hero-shop', 'custom_hero_shop_shortcode');